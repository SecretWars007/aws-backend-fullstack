import { WalletCard, WalletMovement, RechargeProvider, TransferSession } from '../entities/Wallet';
...
export interface IWalletRepository {
  ...
  validateTargetCellphone(cellphone: string): Promise<{ name: string; id: number } | null>;
